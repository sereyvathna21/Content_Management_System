  ...
  useEffect(() => {
    const fetchTopicData = async () => {
      ...
      try {
        ...
        // Fetch specific topic "assistance"
        const res = await axios.get(`${apiUrl}/api/public/social/topics/assistance?lang=${locale}`);
        setTopicData(mapApiTopicToRenderer(res.data));
      } catch (err) {
        console.error("Failed to load assistance topic details", err);
