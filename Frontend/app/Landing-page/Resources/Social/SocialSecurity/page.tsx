  ...
  useEffect(() => {
    const fetchTopicData = async () => {
      ...
      try {
        ...
        // Fetch specific topic "security"
        const res = await axios.get(`${apiUrl}/api/public/social/topics/security?lang=${locale}`);
        setTopicData(mapApiTopicToRenderer(res.data));
      } catch (err) {
        console.error("Failed to load security topic details", err);
