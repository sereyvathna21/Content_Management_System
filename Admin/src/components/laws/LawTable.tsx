                          ...
                          <TableCell className="px-5 py-3 sm:px-6 text-start">
                            ...
                            >
                              <div className="flex items-center gap-3">
                                <div className="font-medium line-clamp-2 text-left max-w-[250px] sm:max-w-[350px] md:max-w-[450px] lg:max-w-[600px] xl:max-w-[800px] whitespace-normal wrap-break-words">{tr.title}</div>
                              </div>
                            </button>
                          </TableCell>
    ...
    {onDelete && (
      <Modal isOpen={isDeleteOpen} onClose={() => setIsDeleteOpen(false)} className="max-w-md p-6">
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">{t("LawTable.confirmDeleteTitle")}</h3>
          <p className="text-gray-500 mb-6">
            {t("LawTable.confirmDeleteText")}
          </p>
          ...
          <div className="flex gap-3 w-full">
            ...
            >
              {isDeleting ? "Deleting..." : t("LawTable.delete")}
            </button>
          </div>
        </div>
      </Modal>
