  ...
  return (
    <div className="fixed inset-0 z-99999 overflow-y-auto overflow-x-hidden">
      <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
        {!isFullscreen && (
          <div
            className={(backdropClassName ?? "fixed inset-0 h-full w-full bg-gray-900/40 backdrop-blur-sm") + " z-99998"}
            onClick={onClose}
          ></div>
        )}
        <div
          ref={modalRef}
          className={`${contentClasses} ${className || ""} z-100000 my-8 text-left`}
