...
import { TreeSection } from "../../types/about.types";
                            ...
                            <div className="flex flex-col min-w-0 pr-4">
                                <div className="flex items-center gap-2 mb-0.5">
                                    <span className={`text-[10px] uppercase font-bold tracking-wider px-1.5 py-0.5 rounded ${
                                        ...
                                        {s.depth === 0 ? (t("sectionTree.subTab") || "Sub-Tab") : (t("sectionTree.contentBlock") || "Content Block")}
                                    </span>
                                </div>
                                <span className={`text-sm font-medium truncate ${isActive ? "text-primary" : "text-gray-800"}`}>
                                    {getTitle(s)}
                                </span>
                                <span className="text-xs text-gray-400 truncate font-mono mt-0.5">
                                    {s.sectionKey}
                                </span>
                            </div>
